...
import (
	...
	country "github.com/Gasoid/workalendar/europe/poland"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.January, 6, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.May, 3, 0, 0, 0, 0, time.UTC)
