...
import (
	...
	country "github.com/Gasoid/workalendar/europe/monaco"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.January, 27, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.November, 19, 0, 0, 0, 0, time.UTC)
