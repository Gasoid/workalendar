package luxembourg_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/luxembourg"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.June, 23, 0, 0, 0, 0, time.UTC)
