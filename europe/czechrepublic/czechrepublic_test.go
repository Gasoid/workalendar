package czechrepublic_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/czechrepublic"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.May, 8, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.July, 5, 0, 0, 0, 0, time.UTC)
