package hungary_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/hungary"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.March, 15, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.August, 20, 0, 0, 0, 0, time.UTC)
