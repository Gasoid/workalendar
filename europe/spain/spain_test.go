...
import (
	...
	country "github.com/Gasoid/workalendar/europe/spain"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.October, 12, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.December, 6, 0, 0, 0, 0, time.UTC)
