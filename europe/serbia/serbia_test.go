...
import (
	...
	country "github.com/Gasoid/workalendar/europe/serbia"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.February, 15, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.November, 11, 0, 0, 0, 0, time.UTC)
