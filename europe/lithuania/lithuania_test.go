package lithuania_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/lithuania"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.February, 16, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.March, 11, 0, 0, 0, 0, time.UTC)
...
func TestGetHoliday(t *testing.T) {
	...
	v := "Restoration of the State Day"
