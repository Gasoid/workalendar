...
import (
	...
	country "github.com/Gasoid/workalendar/europe/greece"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.March, 25, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.October, 28, 0, 0, 0, 0, time.UTC)
