package romania_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/romania"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.January, 24, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.August, 15, 0, 0, 0, 0, time.UTC)
