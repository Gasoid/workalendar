package iceland_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/iceland"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.June, 17, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.December, 31, 0, 0, 0, 0, time.UTC)
