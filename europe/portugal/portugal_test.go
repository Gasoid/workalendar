package portugal_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/portugal"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(2020, time.April, 25, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(2020, time.June, 10, 0, 0, 0, 0, time.UTC)
