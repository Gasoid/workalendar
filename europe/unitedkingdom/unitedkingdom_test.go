package unitedkingdom_test

import (
	"testing"
	"time"

	country "github.com/Gasoid/workalendar/europe/unitedkingdom"
	"github.com/stretchr/testify/assert"
)

var (
	holiday1   = time.Date(1973, time.November, 14, 0, 0, 0, 0, time.UTC)
	holiday2   = time.Date(1977, time.June, 7, 0, 0, 0, 0, time.UTC)
